...
public class SmokeSuite {
	...
	public void validateCosting() {
		try {
			...
			WebElement ActualManufacturingCountry = driver
					.findElement(By.xpath("//input[@formcontrolname='ManufacturingCountry']"));
			...
			WebElement ActualLifeTimeQR = driver
					.findElement(By.xpath("//input[@formcontrolname='lifeTimeQtyRemaining']"));
			WebElement ProductLifeRemaining = driver
					.findElement(By.xpath("//input[@formcontrolname='prodLifeRemaining']"));
			int ExpectedLifeTimeQR = (Integer.parseInt(ActualAnnualVolume.getAttribute("value"))
					* Integer.parseInt(ProductLifeRemaining.getAttribute("value")));
